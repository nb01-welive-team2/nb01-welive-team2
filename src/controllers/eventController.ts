...
import {
  CreateEventBodyStruct,
  EventIdParamStruct,
  PatchEventBodyStruct,
} from "../structs/eventStructs";
...
import {
  ResponseEventCommentDTO,
  ResponseEventDTO,
  ResponseEventListDTO,
} from "../dto/eventDTO";
...
export async function getEventList(req: Request, res: Response) {
  ...
  res.send(new ResponseEventListDTO(result));
}
[
  {
    id: "01978699-bee1-7d41-8b80-32b587cacc84",
    start: "2025-06-29T04:00:00.000Z",
    end: "2025-06-30T05:00:59.999Z",
    title: "119",
...
export async function editEvent(req: Request, res: Response) {
  ...
  const data = create(req.body, PatchEventBodyStruct);
